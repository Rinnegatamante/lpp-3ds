...
{	
	...
	wav_file->wavebuf = NULL;
	wav_file->wavebuf2 = NULL;
	...
	wav_file->audiotype = my_info->channels;
	...
	}else wav_file->sourceFile = (u32)vf;
...
static int lua_playWav(lua_State *L)
{
	...
	// Resetting wav struct for non native Audiocodecs
